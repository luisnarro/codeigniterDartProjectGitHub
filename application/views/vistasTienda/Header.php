			...
			<div id="mainMenu" class="h_menu">
			    <nav class="navbar navbar-default">
					<div class="collapse navbar-collapse">
						...
						// Si hay que añadir más elemtnos en el menú, hay que hacerlo mediante el DOM de la página. Con el método 
						// utilizado, únicamente carga elementos (y sub-elementos) almacenados en la base de datos.
						?>
					</div>
			    </nav>
			</div>
